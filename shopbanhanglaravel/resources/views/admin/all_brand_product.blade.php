  ...
  <div class="panel panel-default">
    ...
    <div class="table-responsive">
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          <!-- bien $all_brand_product chinh la key cua with ->with('all_brand_product', $all_brand_product);-->
          ...
          <tr>
            ...
            <td>
              <a href="{{URL::to('/edit-brand-product/'.$cate_pro->brand_id)}}" class="active styling-edit" ui-toggle-class="">
                ...
                <a onclick="return confirm('Bạn chắc chắn muốn xoá chứ?')" href="{{URL::to('/delete-brand-product/'.$cate_pro->brand_id)}}" class="active styling-edit" ui-toggle-class="">
