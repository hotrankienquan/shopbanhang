...
class ProductController extends Controller
{
    ...
    public function add_product (){
        $this->AuthLogin();
        $cate_product = DB::table('tbl_category_products')->orderBy('category_id', 'desc')
        ->get();
        $brand_product = DB::table('tbl_brand_products')->orderBy('brand_id', 'desc')
        ->get();
    ...
    public function save_product (Request $request){
        ...
        $data = array();
        // $request->product_cate : product_cate chinh la ten cua the ben add_product.blade
        ...
        if($get_image){
            ...
            // ham explode phan tach chuoi tu dau cham (.), current la lay chuoi phia truoc dau cham
    ...
    public function update_product(Request $request, $product_id){
        ...
        $data = array();
        //update cot tuong ung voi name request vao
        $data['product_name'] = $request->product_name;
        $data['product_price'] = $request->product_price;
        $data['product_desc'] = $request->product_desc;
        $data['product_content'] = $request->product_content;
    ...
    public function details_product($product_id){
        ...
        ->join('tbl_category_products','tbl_products.category_id', '=', 'tbl_category_products.category_id')
        ->join('tbl_brand_products', 'tbl_products.brand_id', '=', 'tbl_brand_products.brand_id')
        ->where('tbl_category_products.category_id', $category_id)
        ->whereNotIn('tbl_products.product_id', [$product_id])->get();
